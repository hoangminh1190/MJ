...
public class UilImgLoader implements ImgLoader {
    ...
    public void onPresentImage(ImageView imageView, String imageUri, int size) {
        ...
        instance.init(ImageLoaderConfiguration.createDefault(imageView.getContext()));

        instance.displayImage(scheme.wrap(imageUri), imageView, new DisplayImageOptions.Builder()
